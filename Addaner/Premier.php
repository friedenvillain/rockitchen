	...
	<body>
		<!-- Wrapper -->
			<div id="wrapper">
				...
				<!-- Note: The "styleN" class below should match that of the header element. -->
					<section id="banner" class="major">
						<div class="inner">
							<header class="major">
								<h1  style="text-shadow:3px 3px 15px #000000;">尊爵 簡介</h1>
							</header>
								<span class="image">
									<img src="../images/雅典娜/尊爵/98.jpg" style="width:100%;height:100%;" alt="" />
								</span>
							<!-- <div class="content">
								<h2  style="font-family:微軟正黑體; font-size:32px;"></h2>
							</div> -->
						</div>
					</section>
			...
			<section id="two" class="spotlights">
				<section>
					<div class="image">
						<img src="../images/雅典娜/尊爵/99.jpg" style="width:100%;height:100%;" alt="" data-position="center center" />
					</div>
					<div class="content">
						<div class="inner">
							<!-- <header class="major">
							...
							<p  style="font-family:微軟正黑體; font-size:28px;">尊爵系列是<b>  雅典娜  </b>唯一的實木系列。不論您想要打造的是<b>：  </b>莊園般的浪漫、工業風的執著  還是  美式鄉村的純樸，尊爵系列都能一次滿足您。我們擁有多種門版類型可供您選擇。木材與石材，低調的愛情，高調享受。</p>
						</div>
					</div>
				</section>
				<section>
					<div class="image">
						<img src="../images/雅典娜/尊爵/wood.jpg" style="width:100%;height:100%;" alt="" data-position="center center" />
					</div>
					<div class="content">
						<div class="inner">
							<header class="major">
							...
							<p  style="font-family:微軟正黑體; font-size:28px;">
							實木門板是以整塊原木裁切而成，門板上所呈現的紋路都來自於樹木，而木材本身能散發出樹木原始的香味。是最天然的素材，無化學汙染。非常適合崇尚無毒家園的您。讓家中多一份地球原始的味道。
							</p>
						...
						<section id="three">
							<div class="inner">
								...
								<span style="font-family:微軟正黑體; font-size:28px;">前往察看樣品圖片</span>
								<div align="right"><a href="Premier_GALARY.html" class="button next" >瞭解更多</a></div>
							</div>
						</section>
<hr/>							
							<!-- Footer -->
					<footer id="footer">
						<div class="inner">
							<ul class="icons">
								...
								<span>  商品內容以實際為主 ， 歡迎來電諮詢、預約參觀</span>
							</ul>
							<ul class="copyright">
								<li>&copy; 磐石廚飾有限公司</li>
								<li>Since 1991</li>
